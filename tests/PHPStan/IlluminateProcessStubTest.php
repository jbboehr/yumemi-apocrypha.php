...
final class IlluminateProcessStubTest extends PHPStanTestCase
{
    public static function getAdditionalConfigFiles(): array
    {
        return [
            ...
            __DIR__ . '/illuminate-process-stub.neon',
        ];
    }
    ...
    public function testUnitTagsArePromotedByTheStubParser(): void
    {
        ...
        foreach (['process.stub', 'process-13.stub'] as $file) {
            $phpDocs = $this->methodPhpDocs($parser, $file);

            self::assertStringContainsString("unit_int<'second'>", $phpDocs['PendingProcess::timeout']);
            self::assertStringContainsString("unit_int<'second'>", $phpDocs['PendingProcess::idleTimeout']);
        }
    }
