...
$methods = [
    Illuminate\Support\Benchmark::class => ['measure' => ['benchmarkables', 'iterations'], 'value' => ['callback']],
    Illuminate\Support\Sleep::class => ['sleep' => ['duration'], 'usleep' => ['duration']],
    Illuminate\Support\Timebox::class => ['call' => ['callback', 'microseconds']],
];

foreach ($methods as $class => $expectedMethods) {
    $reflection = new ReflectionClass($class);

    foreach ($expectedMethods as $methodName => $parameterNames) {
