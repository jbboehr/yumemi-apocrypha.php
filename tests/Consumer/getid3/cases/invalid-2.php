...
function acceptGetId3V2Bytes(int $bytes): void
{
}

/** @param unit_int<'second'>|unit_float<'second'> $duration */
function acceptGetId3V2Duration(int|float $duration): void
{
}
...
if (isset($info['filesize'])) {
    acceptGetId3V2Duration($info['filesize']);
}

if (isset($info['playtime_seconds'])) {
    acceptGetId3V2Bytes($info['playtime_seconds']);
}

if (isset($info['bitrate'])) {
    acceptGetId3V2Duration($info['bitrate']);
}

if (isset($info['audio']['sample_rate'])) {
    acceptGetId3V2Duration($info['audio']['sample_rate']);
}
