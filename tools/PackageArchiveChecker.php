...
final readonly class PackageArchiveChecker
{
    ...
    private const REQUIRED_FILES = [
        ...
        'stubs/illuminate/auth-cache-token-repository-with-prefix.stub',
        'stubs/illuminate/auth-cache-token-repository.stub',
        'stubs/illuminate/auth-database-token-repository-11.stub',
        'stubs/illuminate/auth-database-token-repository-12.stub',
        'stubs/illuminate/auth-password-broker-timebox.stub',
        'stubs/illuminate/auth-session-guard-timebox.stub',
